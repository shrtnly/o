...
const COURSE_ID = 'db9d58f1-3b31-4044-ba3c-0b3d2940b450';
...
async function syncProductivityCourse() {
  const sourcePath = path.join(process.cwd(), 'database', 'courses', 'productivity_and_time_management.json');
  ...
  try {
    ...
    fs.writeFileSync(path.join(process.cwd(), 'scratch', 'productivity_and_time_management_backup.json'), finalJsonString, 'utf-8');
    
    console.log('✓ Local files updated successfully:');
    console.log('  - database/courses/productivity_and_time_management.json');
    console.log('  - scratch/productivity_and_time_management_backup.json');
    console.log('★ Productivity & Time Management Course sync completed successfully!');
