    ...
    return (
        <div style={{ maxWidth: '800px', margin: '40px auto', padding: '0 20px', color: 'var(--color-text)' }}>
            ...
            <div style={{ lineHeight: '1.6' }}>
                ...
                <h3 style={{ marginTop: '20px' }}>1. তথ্য সংগ্রহ</h3>
                ...
                <h3 style={{ marginTop: '20px' }}>2. তথ্যের ব্যবহার</h3>
                ...
                <h3 style={{ marginTop: '20px' }}>3. ডাটা সিকিউরিটি</h3>
                ...
                <h3 style={{ marginTop: '20px' }}>4. আপনার নিয়ন্ত্রণ</h3>
