    ...
    return (
        <div style={{ maxWidth: '800px', margin: '40px auto', padding: '0 20px', color: 'var(--color-text)' }}>
            ...
            <div style={{ lineHeight: '1.6' }}>
                ...
                <h3 style={{ marginTop: '20px' }}>১. অ্যাকাউন্ট তৈরি</h3>
                ...
                <h3 style={{ marginTop: '20px' }}>২. সেবার ব্যবহার</h3>
                ...
                <h3 style={{ marginTop: '20px' }}>৩. মেধা সম্পদ</h3>
                ...
                <h3 style={{ marginTop: '20px' }}>৪. পরিবর্তন</h3>
